...
const CustomSoftware = props => {
  ...
  return (
    <Grid container direction='column'>
      ...
      {/* Icons for lightbulb, stopwatch, and cash  Block */}
      <Grid
        item
        container
        direction='row'
        ...
        <Grid
          ...
          <Grid item>
            <img src='/assets/stopwatch' alt='Stop watch ' />
          </Grid>
        </Grid>
        <Grid
          item
      ...
      {/* Automation and User Experience Design Block  */}
      <Grid
        item
        container
        direction={matchesMD ? 'column' : 'row'}
